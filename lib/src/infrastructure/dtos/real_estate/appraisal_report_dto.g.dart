...
AppraisalReportDto _$AppraisalReportDtoFromJson(
  ...
  currentLandUse: json['Standard_land_Current_status_of_land_use'] as String,
  buildingStructure:
      json['Standard_land_Current_state_of_land_use_Structure_code'] as String?,
  floorsAboveGround:
      json['Standard_land_Current_state_of_land_use_Number_of_above-ground_floors']
          as String?,
  basementFloors:
      json['Standard_land_Current_state_of_land_use_Number_of_basement_floors']
          as String?,
  surroundingAreaUse:
  ...
  transactionPriceBenchmark:
      json['Application_of_appraisal_method_Transaction_comparison_method_benchmark_price']
          as String?,
  netIncomePrice:
      json['Application_of_appraisal_method_Income_capitalization_method_Income_price']
          as String?,
  costApproachPrice:
...
Map<String, dynamic> _$AppraisalReportDtoToJson(
  AppraisalReportDto instance,
) => <String, dynamic>{
  ...
  'Standard_land_number_Use_classification_code': instance.useClassification,
  ...
  'Standard_area_Surrounding_area_usage_status': instance.surroundingAreaUse,
